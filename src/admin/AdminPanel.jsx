...
export default function AdminPanel() {
  ...
  const handleSendTestEmail = async () => {
    ...
    const testPayload = {
      ...
      name: 'Website Tester (Jaliyan Exim Admin)',
      company: 'Jaliyan Exim International Test',
      email: emailConfig.recipientEmail || 'jaliyanexim2706@gmail.com',
  ...
  const totalProductsCount = Object.keys(catalogConfigs).reduce((acc, k) => acc + ((catalogConfigs[k].list || []).length), 0);
        ...
        <nav style={{
          ...
          <button
            ...
            style={{
              ...
              padding: '12px 14px',
              borderRadius: '12px',
              backgroundColor: mainTab === 'catalog' ? '#0284C7' : 'transparent',
              ...
              boxShadow: mainTab === 'catalog' ? '0 4px 14px rgba(14, 165, 233, 0.35)' : 'none'
            }}
          >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(170px, 1fr))', gap: '14px', marginBottom: '28px' }}>
            ...
            <div 
              ...
              style={{ 
                ...
                borderRadius: '16px', 
                padding: '16px', 
                border: mainTab === 'catalog' ? '2px solid #0284C7' : '1.5px solid #E2E8F0', 
          ...
          <div>
            ...
            <div style={{
              ...
              {mainCategoriesList.map((cat) => {
                const cfg = catalogConfigs[cat.id] || { name: cat.name, color: cat.color || '#0EA5E9', list: [] };
                ...
                return (
                  <button
                    ...
                    style={{
                      padding: '10px 18px',
                      borderRadius: '12px',
                      backgroundColor: isSelected ? (cat.color || '#0284C7') : '#F8FAFC',
                      color: isSelected ? '#FFFFFF' : '#0B2240',
                      border: isSelected ? `1px solid ${cat.color || '#0284C7'}` : '1px solid #E2E8F0',
                      fontWeight: 800,
                      fontSize: '13.5px',
                      cursor: 'pointer',
                      display: 'inline-flex',
                  ...
                  >
                    <IconC size={16} style={{ color: isSelected ? '#FFFFFF' : (cat.color || '#0EA5E9') }} />
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                <input
                  type="email"
                  placeholder="jaliyanexim2706@gmail.com"
