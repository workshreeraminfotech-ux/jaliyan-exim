    ...
    <section className="py-80 bg-light" id="contact-section">
      <div className="container">
        ...
        <div className="contact-grid">
            ...
            <div className="contact-info-box">
              <div className="contact-info-item">
                ...
                <div className="ci-text">
                  <strong>+91 97266 73414 / +91 90330 39649</strong>
              ...
              <div className="contact-info-item">
                ...
                <div className="ci-text">
                  <strong>jaliyanexim2706@gmail.com</strong>
          ...
          >
            <iframe
              src="https://maps.google.com/maps?q=Surat,+Gujarat,+India&t=&z=14&ie=UTF8&iwloc=&output=embed"
