        ...
        <div className="contact-grid">
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '38px', fontWeight: 900, color: '#fff', marginBottom: '20px', lineHeight: 1.2 }}>
              Get In Touch With <span>Jaliyan Exim Team</span>
            </h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                ...
                <div>
                  ...
                  <a href="tel:+919726673414" style={{ fontSize: 15, color: 'rgba(255, 255, 255, 0.85)', display: 'block' }}>+91 97266 73414</a>
                  <a href="tel:+919033039649" style={{ fontSize: 15, color: 'rgba(255, 255, 255, 0.85)', display: 'block' }}>+91 90330 39649</a>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                ...
                <div>
                  ...
                  <a href="mailto:jaliyanexim2706@gmail.com" style={{ fontSize: 15, color: 'rgba(255, 255, 255, 0.85)' }}>jaliyanexim2706@gmail.com</a>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 14, color: 'rgba(255, 255, 255, 0.85)' }}>Rajkot, Gujarat, India</p>
                </div>
              </div>
