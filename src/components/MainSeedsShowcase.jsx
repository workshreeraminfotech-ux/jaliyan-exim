    ...
    >
      <div className="container">
        ...
        <div style={{ textAlign: 'center', maxWidth: '780px', margin: '0 auto 36px' }}>
          ...
          {/* Eyebrow Badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(56, 189, 248, 0.12)', border: '1px solid rgba(56, 189, 248, 0.4)', padding: '6px 20px', borderRadius: '100px', fontSize: '13px', fontWeight: 800, color: '#0284C7', letterSpacing: '0.8px', textTransform: 'uppercase', marginBottom: '14px', boxShadow: '0 2px 10px rgba(56, 189, 248, 0.12)' }}>
