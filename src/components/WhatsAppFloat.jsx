...
export default function WhatsAppFloat() {
  return (
    <div className="wa-float-container">
      <a
        href="https://wa.me/919726673414?text=Hello%20Jaliyan%20Exim%2C%20I%20would%20like%20to%20request%20an%20export%20quotation%20for%20spices%20and%20agro%20commodities."
        target="_blank"
        rel="noopener noreferrer"
        className="wa-float-btn"
        aria-label="Chat with Jaliyan Exim on WhatsApp"
        title="Chat on WhatsApp (+91 97266 73414)"
      >
