          ...
          <div className="cta-banner-grid">
            ...
            <div className="cta-banner-content">
              ...
              <p className="cta-banner-desc">
                Partner with Jaliyan Exim for premium spices, agro commodities, and dehydrated fruits & vegetables delivered to your port with guaranteed purity and complete export compliance.
              </p>
