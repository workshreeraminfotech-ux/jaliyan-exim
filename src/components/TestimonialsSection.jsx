...
const testimonials = [
  {
    ...
    stars: 5,
    text: 'Jaliyan Exim has been our trusted agro supplier. Their recent container dispatch to Malaysia arrived in perfect condition with 100% purity and fast customs clearance.'
  },
  {
    name: 'Sofia Martinez',
  ...
  },
  {
    ...
    stars: 5,
    text: 'From whole ground spices to sesame seeds, every single dispatch from Jaliyan Exim meets top international standards. Their professionalism and export speed are unmatched.'
  }
];
          ...
          <div style={{ position: 'relative' }}>
            <div className="testi-image-wrap">
              <img
                ...
                alt="Testimonials Showcase — Jaliyan Exim"
              />
            </div>
