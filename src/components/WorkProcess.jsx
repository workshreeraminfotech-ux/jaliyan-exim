      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          ...
          <p style={{ fontSize: '16px', color: 'var(--gray)', maxWidth: '620px', margin: '0 auto', lineHeight: 1.6 }}>
            We ensure the smooth journey of your spices, agro commodities, and dehydrated produce from trusted Indian origins to global destination ports with zero compromise on quality and speed.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                  <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: 'linear-gradient(135deg, #0EA5E9 0%, #38BDF8 100%)', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 6px 18px rgba(56, 189, 248, 0.3)' }}>
                    <Icon size={24} />
                  </div>
