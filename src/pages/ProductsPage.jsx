        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              100% Pure Indian Spice Exporter • {productsList.length} Export Spices
            </span>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(14, 165, 233, 0.3)' }}>
      ...
      <div className="container" style={{ marginTop: '-40px', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <input
                type="text"
                placeholder="Search spices & dehydrated foods (e.g. Turmeric, Cumin, Dehydrated Onion Flakes, Garlic Powder, Mango Slices...)"
                value={searchTerm}
        ...
        {filteredProducts.length === 0 && (
          <div style={{
            ...
            >
              View All {productsList.length} Spices
            </button>
          </div>
        )}
      </div>
