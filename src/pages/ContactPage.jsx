...
const contactCards = [
  {
    icon: Phone, label: 'Phone 1 / WhatsApp',
    value: '+91 97266 73414',
    sub: 'Mon–Sat, 9AM – 6PM IST',
    href: 'tel:+919726673414',
    color: '#0284C7'
  },
  {
    icon: Phone, label: 'Phone 2 / WhatsApp',
    value: '+91 90330 39649',
    sub: 'Mon–Sat, 9AM – 6PM IST',
    href: 'tel:+919033039649',
    color: '#0EA5E9'
  },
  {
    icon: Mail, label: 'Email Address',
    value: 'jaliyanexim2706@gmail.com',
    sub: 'We reply within 24 hours',
    href: 'mailto:jaliyanexim2706@gmail.com',
    color: '#38BDF8'
  },
  {
    ...
    <div>
      ...
      <section style={{
        ...
        <img 
          ...
          alt="Contact Jaliyan Exim Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ maxWidth: '820px', margin: '0 auto' }}>
            ...
            <h1 style={{
              ...
              Contact <span style={{ color: 'var(--gold)' }}>Jaliyan Exim</span>
            </h1>
      ...
      {/* Contact Info Cards */}
      <section style={{ background: '#F8FAFC', padding: '48px 0', borderBottom: '1px solid var(--border)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
            {contactCards.map((c, i) => (
              <motion.div
                ...
                whileHover={{ y: -4, borderColor: 'var(--gold)', boxShadow: '0 12px 30px rgba(14, 165, 233, 0.15)' }}
        ...
        <div className="container">
          <div className="contact-page-grid">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input name="product" placeholder="e.g. Cumin Seeds, Basmati Rice, Dehydrated Onion Flakes" value={form.product} onChange={handleChange} />
                  </div>
                  <div className="form-group">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              >
                <iframe
                  src="https://maps.google.com/maps?q=Rajkot,+Gujarat,+India&t=&z=13&ie=UTF8&iwloc=&output=embed"
                  title="Jaliyan Exim Location - Rajkot, Gujarat"
                  allowFullScreen
                  loading="lazy"
              ...
              >
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=919726673414&text=Hi%20Jaliyan%20Exim!%20I%20would%20like%20to%20enquire%20about%20your%20products."
                  target="_blank"
