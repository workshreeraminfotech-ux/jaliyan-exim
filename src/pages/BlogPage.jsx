    ...
    <div style={{ backgroundColor: '#F8FAFC', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <section style={{
        ...
        <img 
          ...
          alt="Jaliyan Exim Agro Blog Background" 
          style={{
            position: 'absolute',
            inset: 0,
            width: '100%',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ maxWidth: '820px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <h1 style={{
              ...
              <span style={{ color: 'var(--gold)' }}>Market Insights</span>
            </h1>
          ...
          <div style={{
            ...
            {filtered.slice(1).map((b, idx) => (
              <motion.div
                ...
                whileHover={{ y: -5, boxShadow: '0 16px 36px rgba(14, 165, 233, 0.2)', borderColor: 'var(--gold)' }}
              >
                <div style={{
                  height: '210px',
                  backgroundColor: '#FFFFFF',
