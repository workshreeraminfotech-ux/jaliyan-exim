        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={{
              ...
              Precision Architectural & Furniture Hardware • {productsList.length} Items
            </span>
            ...
            <h1 style={{
              ...
              <span style={{ color: 'var(--gold)' }}>Architectural Hardware Catalogue</span>
            </h1>
            ...
            <p style={{
              ...
              Stainless Steel SS 304/316 Door Handles, Mortise Locks, Heavy-Duty Butt & Bearing Hinges, Tower Bolts & Glass Architectural Fittings for export supply.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(14, 165, 233, 0.4)' }}>
                ...
                <span>SS 304 / 316 Marine Grade</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(14, 165, 233, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: 'var(--gold)' }} />
                <span>PVD, Satin & Matte Finishes</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255, 255, 255, 0.1)', padding: '8px 18px', borderRadius: '100px', border: '1px solid rgba(14, 165, 233, 0.4)' }}>
                <CheckCircle2 size={16} style={{ color: 'var(--gold)' }} />
                <span>Custom OEM / Brand Packaging</span>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <AnimatePresence>
            {filteredProducts.map((product, idx) => (
              <motion.div
                ...
                whileHover={{ y: -6, boxShadow: '0 16px 40px rgba(14, 165, 233, 0.2)', borderColor: 'var(--gold)' }}
